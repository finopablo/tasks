...
ENDL;
	...
	public function set_var($sVarName, $sValue){
		//if( ( is_array($sValue) || ( get_class($sValue) == "stdClass") ) ) {
	...
	public function PrintAll(){
        ...
        public function fTranslate($oDictionary){
            foreach ($this->vLabels as $oLabel){
                    $this->set_var($oLabel,$oDictionary[$oLabel]);
            }
